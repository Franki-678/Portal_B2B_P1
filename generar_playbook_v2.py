"""
Genera Portal_B2B_P2_Playbook_v2.docx con el flujo completo actualizado.
Incluye: estados, transiciones, roles, modales, WhatsApp, conflictos y resoluciones.
Ejecutar: python generar_playbook_v2.py
"""
...
OUTPUT_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "Portal_B2B_P2_Playbook_v2.docx")
...
r2 = p2.add_run('Playbook de Flujos y Máquina de Estados — v2.0')
r2.font.size = Pt(14)
r2.font.color.rgb = C_ZINC400

p3 = doc.add_paragraph()
p3.alignment = WD_ALIGN_PARAGRAPH.CENTER
r3 = p3.add_run('Flujo completo actualizado · Mayo 2026')
r3.font.size = Pt(10)
...
# ════════════════════════════════════════════════════
add_heading(doc, '10. RESUMEN EJECUTIVO', level=1)
...
r_fin = p_fin.add_run('Portal B2B Autopartes — Playbook v2.0 — Flujo completo actualizado')
